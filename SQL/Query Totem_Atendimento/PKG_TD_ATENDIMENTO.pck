CREATE OR REPLACE PACKAGE MVCUSTOM.PKG_TD_ATENDIMENTO IS

  PROCEDURE prc_td_cria_atendimento(v_cpf IN VARCHAR2, v_paciente in VARCHAR2, v_dt_nascimento in date);
  FUNCTION fnc_paciente_dentro_do_horario(hr_agendamento in DATE, hr_chegada in DATE) RETURN Varchar2;
